...
declare_id!("4FWXDxhLGqGvdG3gbeS7PqXBoQFqsDBcWa1Bp578PamE");
...
#[inline(never)]
fn reconstruct_secret(x_values: &[u64], y_values: &[u64]) -> Result<u64> {
...
pub struct Initialize<'info> {
    ...
    pub upgrade_file: Account<'info, UpgradeFile>,
